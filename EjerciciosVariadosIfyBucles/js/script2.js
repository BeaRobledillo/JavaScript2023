...
*/
/* let numInicial = prompt ('Ingrese el número inicial:');
console.log ('Tu número inicial es: ' + numInicial);
let razon = prompt ('Ingrese la razón:');
console.log ('Tu número razón es: ' + razon);
let termino = numInicial;
//console.log(termino);
do {
  termino = termino * razon;
  console.log (termino);
} while (termino * razon < 100);
console.log ('__________________________'); */
//CASCA SI METES CERO
...
let escribir = true;
while (escribir) {
  let numeritos = prompt ('Introduzca un número (O escriba 0 para terminar)');
  numeritos = Number (numeritos);
  console.log ('Introdujiste: ' + numeritos);
  if (numeritos === '0') {
    console.log ('Introdujiste 0.');
    escribir = false;
  } else {
    sumar += numeritos;
  }
}
console.log ('La suma total de los números es: ' + sum);
console.log ('__________________________');    */
...
/* let numero
do{
  numero=Number(prompt('Introduzca un número (O escriba 0 para terminar)'))
}while(numero!=0)
 */
/* let nu1=0
do {
  nu1=Number(prompt('Dame un número'))
}while(nu1!=0)
console.log ('__________________________');
 */
...
while (flag) {
  let num = prompt("Ingrese un número (escriba 0 para terminar): ");
  num(Number) = num;
  total += num;
  if (num === 0) {
    flag = false;
